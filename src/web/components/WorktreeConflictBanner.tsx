...
export function WorktreeConflictBanner({
  ...
  return (
    <div role="alert" className="bg-red-500/10 border-red-500/30 border-b px-4 py-2">
      <div className="flex items-center justify-between">
        ...
        {count === 1 && (
          <button
            ...
            className="text-red-600 hover:text-red-700 hover:bg-red-500/10 flex items-center gap-1 text-sm font-medium cursor-pointer px-2 py-1 rounded border border-red-500/30 focus:ring-2 focus:ring-red-500 focus:outline-none"
          >
            Switch to resolve
